...
TEST_CLASS(statistics_getter){public :

                                  BEGIN_TEST_METHOD_ATTRIBUTE(getStatisticsFrom1) TEST_OWNER(L"MCBerberov19")
                                      TEST_PRIORITY("High") END_TEST_METHOD_ATTRIBUTE()
                                          TEST_METHOD(getStatisticsFrom1){std::ofstream out("Test.json");
